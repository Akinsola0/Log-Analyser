...
| Route                                                                     | What it is                                                                                                                                            |
| ------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`/`](docs/VISUAL_TOUR.md#marketing-site)                                 | Marketing homepage: dual "I need a tradesman" / "I am a tradesman" split, real reviews, cost-of-a-missed-call comparison, visible tiered pricing, FAQ |
